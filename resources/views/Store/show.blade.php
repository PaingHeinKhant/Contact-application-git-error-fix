        ...
        <div class="row">
            ...
            <div class="mb-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('store.index') }}">Share Contact</a></li>
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <div class="me-4 show-inverse">
                                ...
                                @else
                                    <div class="rand-two" style="background:{{\App\Models\Contact::randBackgroundColor()}} ">{{ \Illuminate\Support\Str::substr((ucfirst($store->shareContact['firstName'])), 0, 1) }}</div>
                                @endif
                            </div>
                            <div class="">
                                <h2>{{ ucfirst($store->shareContact['firstName']) }}  {{ ucfirst($store->shareContact['lastName']) }}</h2>
                                <h5>{{ ucfirst($store->shareContact['company']) }}</h5>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <div class="d-flex align-items-center my-2">
                           ...
                           <h5 class="m-0">{{($store->shareContact['email']) }}</h5>
                       </div>
                        <div class="d-flex align-items-center my-2">
                            <i class="bi bi-telephone fs-5 text-black-50 me-3"></i>
                            <h5 class="m-0">{{ ($store->shareContact['phone']) }}</h5>
                        </div>

                        @if($store->shareContact['birthday']) == null )
                            <div class="d-flex align-items-center my-2">
                        ...
                        @else
                            <div class="d-flex align-items-center my-2">
                                <i class="bi bi-calendar3-event text-black-50 me-3"></i>
                                <h5 class="m-0">{{($store->shareContact['birthday']) }}</h5>
                            </div>
                        @endif
